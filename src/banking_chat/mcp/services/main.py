...
async def get_service_requests(customer_id: str) -> dict[str, Any]:
    ...
    logger.info("Executing get_service_requests for customer_id=%s", customer_id)
...
async def create_service_request(customer_id: str, request_type: str, notes: str | None = None) -> dict[str, Any]:
    ...
    logger.info("Executing create_service_request for customer_id=%s, type=%s", customer_id, request_type)
...
async def block_card(
    ...
    """MCP tool: block_card."""
    logger.info("Executing block_card for customer_id=%s, card=...%s, reason=%s", customer_id, card_last_four, reason)
